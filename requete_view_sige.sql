...
-----------------05052023--------------------
-- View: public.prov_nb_eleve_post_primaire

-- DROP VIEW public.prov_nb_eleve_post_primaire;
...
CREATE OR REPLACE VIEW public.prov_nb_eleve_post_primaire
  ...
  SELECT atlas_admin.code_region,
   ...
   FROM effectif_gp_par_age,
    groupe_pedagogique,
    atlas_admin
  WHERE effectif_gp_par_age.code_etablissement = atlas_admin.code_etablissement 
  AND effectif_gp_par_age.code_type_annee = atlas_admin.code_type_annee 
  AND effectif_gp_par_age.code_etablissement = groupe_pedagogique.code_etablissement 
  AND effectif_gp_par_age.code_type_annee = groupe_pedagogique.code_type_annee 
  AND effectif_gp_par_age.numero_ordre_groupe = groupe_pedagogique.numero_ordre_groupe 
  AND (groupe_pedagogique.code_type_niveau = ANY (ARRAY[10, 11, 12, 13,17,18,19,25]))
  GROUP BY atlas_admin.code_region, atlas_admin.region, atlas_admin.code_province, atlas_admin.province, atlas_admin.code_type_annee, atlas_admin.libelle_type_annee, atlas_admin.code_systeme_enseignement, atlas_admin.systeme_enseignement;

ALTER TABLE public.prov_nb_eleve_post_primaire
    OWNER TO postgres;
...
CREATE OR REPLACE VIEW public._vue_taux_brut_scolarisation_post_primaire
 ...
 SELECT 
    ...
    prov_nb_eleve_post_primaire.code_systeme_enseignement,
   ...
   FROM pop_12_15_ans
     JOIN prov_nb_eleve_post_primaire ON pop_12_15_ans.code_type_annee = prov_nb_eleve_post_primaire.code_type_annee 
     AND pop_12_15_ans.code_regroupement = prov_nb_eleve_post_primaire.code_province
  WHERE prov_nb_eleve_post_primaire.code_systeme_enseignement = ANY (ARRAY[3, 4, 5, 6]);
...
CREATE OR REPLACE VIEW public.prov_nb_eleve_secondaire
  AS
  SELECT atlas_admin.code_region,
    atlas_admin.region,
    atlas_admin.code_province,
  ...
  AND effectif_gp_par_age.code_type_annee = groupe_pedagogique.code_type_annee 
  AND effectif_gp_par_age.numero_ordre_groupe = groupe_pedagogique.numero_ordre_groupe 
  AND (groupe_pedagogique.code_type_niveau = ANY (ARRAY[20,21,22,23,24,26,27,30,31,32]))
  GROUP BY atlas_admin.code_region, atlas_admin.region, atlas_admin.code_province, atlas_admin.province, atlas_admin.code_type_annee, atlas_admin.libelle_type_annee, atlas_admin.code_systeme_enseignement, atlas_admin.systeme_enseignement;

ALTER TABLE public.prov_nb_eleve_secondaire
    OWNER TO postgres;

    CREATE OR REPLACE VIEW public._vue_taux_brut_scolarisation_secondaire
 AS
 SELECT 
    prov_nb_eleve_secondaire.code_region,
    prov_nb_eleve_secondaire.region,
    prov_nb_eleve_secondaire.code_province,
    prov_nb_eleve_secondaire.province,
    prov_nb_eleve_secondaire.code_type_annee,
    prov_nb_eleve_secondaire.libelle_type_annee,
    prov_nb_eleve_secondaire.code_systeme_enseignement,
    pop_16_18_ans.pop_16_18_ans_g AS pop_16_18_ans_g_secondaire,
    pop_16_18_ans.pop_16_18_ans_f AS pop_16_18_ans_f_secondaire,
    prov_nb_eleve_secondaire.prov_insc_f AS prov_insc_f_secondaire,
    prov_nb_eleve_secondaire.prov_insc_g AS prov_insc_g_secondaire
   FROM pop_16_18_ans
     JOIN prov_nb_eleve_secondaire ON pop_16_18_ans.code_type_annee = prov_nb_eleve_secondaire.code_type_annee 
     AND pop_16_18_ans.code_regroupement = prov_nb_eleve_secondaire.code_province
  WHERE prov_nb_eleve_secondaire.code_systeme_enseignement = ANY (ARRAY[3, 4, 5, 6]);

ALTER TABLE public._vue_taux_brut_scolarisation_secondaire
    OWNER TO postgres;
COMMENT ON VIEW public._vue_taux_brut_scolarisation_secondaire
    IS 'taux brut de scolarisation secondaire';
...
CREATE OR REPLACE VIEW public.prov_nb_eleve_12_15_ans_post_primaire
 AS
 SELECT atlas_admin.code_region,
    atlas_admin.region,
    atlas_admin.code_province,
  ...
  AND effectif_gp_par_age.numero_ordre_groupe = groupe_pedagogique.numero_ordre_groupe 
  AND (groupe_pedagogique.code_type_niveau = ANY (ARRAY[10, 11, 12, 13,17,18,19,25]))
  AND (effectif_gp_par_age.code_type_age = ANY (ARRAY[13, 14, 15, 16]))
  GROUP BY atlas_admin.code_region, atlas_admin.region, atlas_admin.code_province, atlas_admin.province, atlas_admin.libelle_type_annee, atlas_admin.code_type_annee;
ALTER TABLE public.prov_nb_eleve_12_15_ans_post_primaire
OWNER TO postgres;
...
CREATE OR REPLACE VIEW public._vue_taux_net_scolairisation_post_primaire
 AS
 SELECT prov_nb_eleve_12_15_ans_post_primaire.code_region,
    prov_nb_eleve_12_15_ans_post_primaire.region,
    prov_nb_eleve_12_15_ans_post_primaire.code_province,
    prov_nb_eleve_12_15_ans_post_primaire.province,
    prov_nb_eleve_12_15_ans_post_primaire.code_type_annee,
    prov_nb_eleve_12_15_ans_post_primaire.libelle_type_annee,
    prov_nb_eleve_12_15_ans_post_primaire.insc_g_12_15 AS inscr_prov_g_12_15,
    prov_nb_eleve_12_15_ans_post_primaire.insc_f_12_15 AS inscr_prov_f_12_15,
    pop_12_15_ans.pop_12_15_ans_g AS pop_prov_g_12_15,
    pop_12_15_ans.pop_12_15_ans_f AS pop_nat_f_12_15
   FROM pop_12_15_ans,
    prov_nb_eleve_12_15_ans_post_primaire
  WHERE pop_12_15_ans.code_type_annee = prov_nb_eleve_12_15_ans_post_primaire.code_type_annee;
...
CREATE OR REPLACE VIEW public.prov_nb_eleve_16_18_ans_secondaire
 AS
 SELECT atlas_admin.code_region,
    atlas_admin.region,
    atlas_admin.code_province,
  ...
  AND effectif_gp_par_age.numero_ordre_groupe = groupe_pedagogique.numero_ordre_groupe 
  AND (groupe_pedagogique.code_type_niveau = ANY (ARRAY[20,21,22,23,24,26,27,30,31,32]))
  AND (effectif_gp_par_age.code_type_age = ANY (ARRAY[17,18,19]))
  GROUP BY atlas_admin.code_region, atlas_admin.region, atlas_admin.code_province, atlas_admin.province, atlas_admin.libelle_type_annee, atlas_admin.code_type_annee;
ALTER TABLE public.prov_nb_eleve_16_18_ans_secondaire
OWNER TO postgres;
...
CREATE OR REPLACE VIEW public._vue_taux_net_scolarisation_secondaire
 AS
 SELECT prov_nb_eleve_16_18_ans_secondaire.code_region,
    prov_nb_eleve_16_18_ans_secondaire.region,
    prov_nb_eleve_16_18_ans_secondaire.code_province,
    prov_nb_eleve_16_18_ans_secondaire.province,
    prov_nb_eleve_16_18_ans_secondaire.code_type_annee,
    prov_nb_eleve_16_18_ans_secondaire.libelle_type_annee,
    prov_nb_eleve_16_18_ans_secondaire.insc_g_16_18 AS inscr_prov_g_16_18,
    prov_nb_eleve_16_18_ans_secondaire.insc_f_16_18 AS inscr_prov_f_16_18,
    pop_16_18_ans.pop_16_18_ans_g AS pop_prov_g_16_18,
    pop_16_18_ans.pop_16_18_ans_f AS pop_nat_f_16_18
   FROM pop_16_18_ans,
    prov_nb_eleve_16_18_ans_secondaire
  WHERE pop_16_18_ans.code_type_annee = prov_nb_eleve_16_18_ans_secondaire.code_type_annee;
